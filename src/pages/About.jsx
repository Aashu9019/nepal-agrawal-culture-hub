      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed language-transition">
              {t('about.description')}
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-600 to-red-700 rounded-2xl p-8 md:p-12 text-white relative overflow-hidden animate-fade-in" style={{animationDelay: '0.8s'}}>
            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-3xl font-bold mb-4 language-transition">{t('about.mission')}</h3>
                <p className="text-red-100 leading-relaxed language-transition">
                  {t('about.missionDesc')}
                </p>
              </div>
